...
Pipeline that turns the Complete/Australia/National (AS 1743) drawings into SVGs under `Complete/Australia/National (AS 1743)/SVGs/`.
...
## Output layout (`Complete/Australia/National (AS 1743)/SVGs/`)
...
`Processing/Australia/QLD/SVGs/<Category>/`), `nsw_extract.py` (register → `Processing/Australia/NSW/SVGs/<family>/`), `sa_extract.py`
