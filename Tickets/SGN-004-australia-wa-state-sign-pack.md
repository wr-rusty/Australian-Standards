---
id: SGN-004
title: Processing/Australia/WA: state sign pack
status: in-progress
priority: P1
area: sources
project: australia
...
Download the register into `Processing/Australia/WA/Original .../`, extract or transcribe into `SVGs/<family>/` with a manifest (same rules as the national set: exact artwork where vector, spec route where only dimensioned drawings), note licence terms in SOURCES.md.
