---
id: SGN-026
title: Processing/USA/District of Columbia: confirm adoption status and any state-specific signs
status: open
priority: P2
area: sources
project: usa
...
Record the adoption status in `Processing/USA/STATES.csv`; if state-only sheets exist, download them and build `Processing/USA/District of Columbia/` like the major-state packs.
